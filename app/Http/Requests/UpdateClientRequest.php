...
class UpdateClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dni'=>'string|unique:clients,dni, '.$this->route('client')->id.'|max:11|min:8',
            'ruc'=>'string|required|unique:clients,ruc, '.$this->route('client')->id.'|max:11|min:11',
            'address'=>'string|required|max:255',
            'phone'=>'string|required|unique:clients,phone, '.$this->route('client')->id.'|max:11|min:9',
    ...
    {
        return [
            'name.required'=>'Esta camnpo es requerido.',
            ...
            'ruc.min'=>'Se requieres de 11 caracteres.',
